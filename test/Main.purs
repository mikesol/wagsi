    ...
    $ runSpec [ consoleReporter ] do
        describe "Tests parser" do
          it "Works on simple imput" do
            ...
            runParser cycleP
              "  tabla2:42" `shouldEqual` Right (noteFromSample S.tabla2_42__Sample)
            runParser cycleP
              "tabla2:42 hc:0" `shouldEqual` Right (Sequential { weight: 1.0, nel: NonEmptyList ((noteFromSample S.tabla2_42__Sample) :| (noteFromSample S.hc_0__Sample) : Nil) })
                          ...
                          Internal
                            { weight: 1.0, nel: NonEmptyList
                                ( (noteFromSample S.diphone2_0__Sample)
                                    :| (Branching { weight: 1.0, nel: NonEmptyList ((noteFromSample S.sitar_0__Sample) :| (noteFromSample S.latibro_0__Sample) : Nil) }) : Nil
                                )
                            } : Nil
          ...
          it "Works on simultaneous cycles 2" do
            runParser cycleP
              "[tabla2:42 <hc:0 tech:0>] , tabla2:42" `shouldEqual` Right (Simultaneous { weight: 1.0, nel: NonEmptyList (Internal { weight: 1.0, nel: NonEmptyList ((noteFromSample S.tabla2_42__Sample) :| (Branching { weight: 1.0, nel: NonEmptyList ((noteFromSample S.hc_0__Sample) :| (noteFromSample S.tech_0__Sample) : Nil) }) : Nil) } :| (noteFromSample S.tabla2_42__Sample) : Nil) })
          it "Works on weights" do
            runParser cycleP
              "[tabla2:42 _ <hc:0 tech:0>] , tabla2:42 _ _" `shouldEqual` Right (Simultaneous { weight: 1.0, nel: NonEmptyList (Internal { weight: 1.0, nel: NonEmptyList ((noteFromSample' 2.0 S.tabla2_42__Sample) :| (Branching { weight: 1.0, nel: NonEmptyList ((noteFromSample S.hc_0__Sample) :| (noteFromSample S.tech_0__Sample) : Nil) }) : Nil) } :| (noteFromSample' 3.0 S.tabla2_42__Sample) : Nil) })
          it "Works on branching cycles with internal cycle" do
            runParser cycleP
              "[tabla2:42 <[hc:0 hc:0] tech:0>] tabla2:42" `shouldEqual` Right (Sequential { weight: 1.0, nel: NonEmptyList (Internal { weight: 1.0, nel: NonEmptyList ((noteFromSample S.tabla2_42__Sample) :| (Branching { weight: 1.0, nel: NonEmptyList ((Internal { weight: 1.0, nel: NonEmptyList ((noteFromSample S.hc_0__Sample) :| (noteFromSample S.hc_0__Sample) : Nil) }) :| (noteFromSample S.tech_0__Sample) : Nil) }) : Nil) } :| (noteFromSample S.tabla2_42__Sample) : Nil) })
        describe "Test cycle to sequence" do
          ...
          it "Works on weights groups" do
            run "[tabla2 _ _ tabla2] [diphone2 <sitar latibro>]" `shouldEqual` Right (NonEmptyList ((NonEmptyList (NoteInTime { duration: 0.375, startsAt: 0.0, cycleLength: 1.0, note: Just $ Note { sample: S.tabla2_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } :| NoteInTime { duration: 0.125, startsAt: 0.375, cycleLength: 1.0, note: Just $ Note { sample: S.tabla2_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } : NoteInTime { duration: 0.25, startsAt: 0.5, cycleLength: 1.0, note: Just $ Note { sample: S.diphone2_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } : NoteInTime { duration: 0.25, startsAt: 0.75, cycleLength: 1.0, note: Just $ Note { sample: S.sitar_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } : Nil)) :| (NonEmptyList (NoteInTime { duration: 0.375, startsAt: 0.0, cycleLength: 1.0, note: Just $ Note { sample: S.tabla2_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } :| NoteInTime { duration: 0.125, startsAt: 0.375, cycleLength: 1.0, note: Just $ Note { sample: S.tabla2_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } : NoteInTime { duration: 0.25, startsAt: 0.5, cycleLength: 1.0, note: Just $ Note { sample: S.diphone2_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } : NoteInTime { duration: 0.25, startsAt: 0.75, cycleLength: 1.0, note: Just $ Note { sample: S.latibro_0__Sample, rateFoT: const 1.0, volumeFoT: const 1.0 } } : Nil)) : Nil))
          it "Works on simultaneous cycles" do
