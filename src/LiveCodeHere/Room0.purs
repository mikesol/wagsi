...
type Acc r
  = ( room0Latch :: ALatchAP GOO | r )

actualizer :: Extern -> { room0Latch :: AudioParameter_ GOO }
actualizer (SceneI { time, headroom: headroom' }) = { room0Latch: pwfs.kick1 { time, headroom } }
  where
  headroom = toNumber headroom' / 1000.0

graph :: forall r. Extern -> { room0Latch :: LatchAP GOO | r } -> _
graph _ _ = {}
